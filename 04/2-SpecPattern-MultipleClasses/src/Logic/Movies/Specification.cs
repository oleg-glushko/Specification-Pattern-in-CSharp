...
// see https://stackoverflow.com/questions/457316/combining-two-expressions-expressionfunct-bool
...
public sealed class MovieDirectedBy : Specification<Movie>
{
    private readonly string _director;

    public MovieDirectedBy(string director)
    {
        _director = director;
    }
